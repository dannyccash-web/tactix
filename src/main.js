...
// Base logical size the game was authored for.
// Phaser will scale the entire canvas uniformly to fit the available screen.
// (Aspect ratio is preserved; extra space becomes letterboxing.)
const BASE_W = 1536;
const BASE_H = 1024;
...
const game = new Phaser.Game({
  ...
  // Keep rendering crisp on high-DPI screens without overloading mobile GPUs.
...
// Some mobile browsers (especially iOS Safari) change the reported viewport height
// as the address bar shows/hides. Refresh scaling on resize/orientation changes.
